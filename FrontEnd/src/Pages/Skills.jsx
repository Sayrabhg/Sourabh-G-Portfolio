            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="div03">
                            <div id="skills" className="div3">
                                <h1 className="py-3">Skills</h1>
                            </div>
                            <main className="main21 d-grid gap-4">
                                <div id="skills">
                                    <p>In the time of graduation i
                                ...
                                <Circularbar />
                                <div id="skills">
                                    <p className="lg:text-lg/7 sm:text-3xl/10 text-justify">The above languages progress bar telling
